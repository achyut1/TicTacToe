...
public class Game
{
	...
	{
		new AIPlayer("Computer1", "X"),
		new AIPlayer("Computer2", "O")
	};
	...
	public Player getWinner()
	{
		...
		{
			if (player.getSymbol().equals(rowSymbol))
				return player;
			if (player.getSymbol().equals(columnSymbol))
				return player;
			if (player.getSymbol().equals(diagonalSymbol))
				return player;
		}
		return null;
	}
